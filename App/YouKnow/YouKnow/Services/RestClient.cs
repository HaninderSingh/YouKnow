...
using YouKnow.Interfaces;
using Plugin.Connectivity;

namespace YouKnow.Services
{
    public sealed class RestClient : IRestClient
    {
      ...
      public  string msg = "PLease Connect To internet and try again";
        private Task<System.Net.Http.HttpResponseMessage> RequestAsync(HttpMethod method, string url, object payload = null)
        {
            ...
            if (CrossConnectivity.Current.IsConnected)
            {
                try
                {
                    ...
                    return GetClient().SendAsync(request, System.Net.Http.HttpCompletionOption.ResponseContentRead);
                }
                catch (Exception ex)
                {
